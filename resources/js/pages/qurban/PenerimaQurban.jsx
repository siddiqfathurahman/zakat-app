...
import CetakKuponButton from "./CetakKuponButton";
...
export default function PenerimaQurban({ penerimas = [], configs = {}, setting = null }) {
    ...
    useEffect(() => {
        setPage(1);
    }, [search, filterStatus, filterAgama, filterRt]);
    ...
    const getJatah = (jiwa, isNonMuslim = false) => {
        ...
        return (
            configs.find((c) => c.kategori === cat && c.jiwa === jiwa) || {
                jatah_sapi: 0,
                jatah_kambing: 0,
            }
        );
    ...
    const [jatahConfig, setJatahConfig] = useState({
        1: {
            jatah_sapi: getJatah(1).jatah_sapi,
            jatah_kambing: getJatah(1).jatah_kambing,
        },
        2: {
            jatah_sapi: getJatah(2).jatah_sapi,
            jatah_kambing: getJatah(2).jatah_kambing,
        },
        3: {
            jatah_sapi: getJatah(3).jatah_sapi,
            jatah_kambing: getJatah(3).jatah_kambing,
        },
        4: {
            jatah_sapi: getJatah(4).jatah_sapi,
            jatah_kambing: getJatah(4).jatah_kambing,
        },
        5: {
            jatah_sapi: getJatah(5).jatah_sapi,
            jatah_kambing: getJatah(5).jatah_kambing,
        },
    });
    ...
    const doDelete = () => {
        router.post(
            `/qurban/input/penerima/${confirmId}/destroy`,
            {},
            {
    ...
    const updateStatus = (row, status) => {
        router.post(`/qurban/input/penerima/${row.id}/update`, {
            ...row,
            status,
        });
    };
    ...
    const handleApplyJatah = () => {
        router.post(
            "/qurban/input/jatah-config/apply",
            {},
            {
                ...
                <div className="overflow-x-auto">
                    <table className="w-full">
                        <thead className="bg-orange-700 text-white text-sm">
                            <tr>
                                <th className="px-4 py-3 text-center border-r border-orange-500/30">
                                    Kategori / Jiwa
                                </th>
                                <th
                                    ...
                                    colSpan={5}
                                >
                                    Muslim (Berdasarkan Jiwa)
                                </th>
                                <th className="px-4 py-3 text-center border-l border-orange-500/30">
                                    Non Muslim
                                </th>
                            </tr>
                            <tr className="bg-orange-500">
                                ...
                                <th className="px-4 py-2 text-center text-xs border-l border-orange-400/30">
                                    Semua Jiwa
                                </th>
                            </tr>
                        </thead>
                        <tbody className="text-sm">
                            <tr className="border-b border-gray-100">
                                <td className="px-4 py-3 text-center font-medium text-gray-700 bg-orange-50 border-r border-gray-100">
                                    Jatah Sapi
                                </td>
                                {[1, 2, 3, 4, 5].map((jiwa) => (
                                    <td
                                ...
                                {[1, 2, 3, 4, 5].map((jiwa) => (
                                    ...
                                    >
                                        <input
                                            type="number"
                                            value={
                                                jatahConfig[jiwa].jatah_kambing
                                            }
                                            onChange={(e) =>
                                                handleJatahConfigChange(
                                                    jiwa,
                        ...
                        <thead>
                            <tr className="bg-orange-700 text-white">
                                {[
                                    ...
                                    <th
                                        key={h}
                                        className="text-left px-3 py-3 text-xs font-semibold uppercase tracking-wide whitespace-nowrap"
                                    >
                                        {h}
                                    </th>
                                ))}
                ...
                <div className="flex justify-center items-center gap-1.5 mt-5">
                    ...
                    {pageNumbers[0] > 1 && (
                        <>
                            <button
                                onClick={() => setPage(1)}
                                className="w-9 h-9 flex items-center justify-center rounded-lg border border-gray-200 text-gray-600 hover:bg-orange-50 text-xs"
                            >
                                1
                            </button>
                            {pageNumbers[0] > 2 && (
                ...
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl">
                        ...
                        <div className="p-6 flex flex-col items-center gap-4">
                            ...
                            <a
                                href={`/qurban/input/qurban/surat-keterangan/${detailData.id}`}
                                target="_blank"
                    ...
                    <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl p-6">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500">
                                    Konfigurasi jatah qurban per jiwa akan
                                    disimpan.
                                </p>
                            </div>
                        </div>
                        <div className="flex justify-end gap-2">
                            ...
                            <button
                                ...
                                className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg px-4 py-2 text-sm font-semibold transition"
                            >
                                Ya, Simpan
                            </button>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl p-6">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500">
                                    Jatah sapi & kambing akan diaplikasikan ke
                                    SEMUA data penerima yang tersimpan saat ini
                                    secara otomatis.
                                </p>
                            </div>
                        </div>
